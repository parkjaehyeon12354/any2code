...
마지막 갱신: 2026-08-26 · 지구과학 시뮬레이션 2개 + 답변 수정·삭제
...
**답변 수정·삭제는 배포 완료. 지구과학 시뮬레이션 2개는 커밋 대기 중입니다.**
실패 중인 테스트는 없습니다.
...
### A. 지구과학 시뮬레이션 두 개를 만들었다 — 대기와 기상, 해양과 순환
...
### B. 답변 수정·삭제를 붙였다 (`44906b0`, `60655d5`)

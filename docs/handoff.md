...
마지막 갱신: 2026-08-26 · 물리 3개 + 지구과학 2개 (물리·지구과학 완성)
...
**답변 수정·삭제와 지구과학 2개는 배포 완료. 물리 3개는 커밋 대기 중입니다.**
실패 중인 테스트는 없습니다.
...
### A. 물리 시뮬레이션 세 개 — Solar 4 Pro 와 나눠서 만들었다
...
### B. 지구과학 시뮬레이션 두 개를 만들었다 — 대기와 기상, 해양과 순환
...
### C. 답변 수정·삭제를 붙였다 (`44906b0`, `60655d5`)

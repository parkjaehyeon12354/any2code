...
마지막 갱신: 2026-08-27 · 생명과학 4개 — 스물한 개로 네 과목을 다 채웠다
...
### B. 심화 탐구가 15개 페이지에서 죽어 있던 것을 고쳤다
...
### D. 물리 시뮬레이션 세 개 — Solar 4 Pro 와 나눠서 만들었다
...
### E. 지구과학 시뮬레이션 두 개를 만들었다 — 대기와 기상, 해양과 순환
...
### F. 답변 수정·삭제를 붙였다 (`44906b0`, `60655d5`)

...
**화학 4개까지 배포 완료. 심화 탐구 링크 수정은 커밋 대기 중입니다.**
실패 중인 테스트는 없습니다.
...
### A. 심화 탐구가 15개 페이지에서 죽어 있던 것을 고쳤다

시뮬레이션 15개 페이지에서 **심화 탐구로 들어갈 수 없었습니다.**
...
### C. 물리 시뮬레이션 세 개 — Solar 4 Pro 와 나눠서 만들었다
...
### D. 지구과학 시뮬레이션 두 개를 만들었다 — 대기와 기상, 해양과 순환
...
### E. 답변 수정·삭제를 붙였다 (`44906b0`, `60655d5`)
